...
export default function Swagprizes({
  ...
  return (
    <div>
      <div className="bg-violet flex flex-col h-fit sm:h-fit md:h-fit lg:h-[29.041rem] w-[20.027rem] sm:w-[20.027rem] md:w-[24.027rem] max-w-[23.5rem] rounded-[2rem] justify-between py-6 items-center">
        <div
