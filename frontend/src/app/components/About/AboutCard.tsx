...
export default function AboutCard({
  ...
  return (
    <div className="primary-aboutpage-background max-w-[32.1rem] sm:h-full flex flex-col lg:h-[39.78rem]  md:h-[35.75rem] h-fit  rounded-[1rem] p-[0.2875rem] m-6 sm:m-8">
