...
export default function MainWinCard({
  ...
  svg,
    ...
    return(
        <div className="flex flex-row  relative top-[2.5rem] left-[2rem]">
            ...
            <div className="w-[19.875rem] lg:w-[41.952rem] h-[6.113rem] lg:h-[10.429rem]">
                <ul className="divide-y-2 divide-gray-200/10">
                    <li>
                        <div className={`${cabinetBold.className} text-[1.25rem] lg:text-[2.25rem] flex justify-end items-end pb-[1rem]`}>
                            {title}
                        </div>
