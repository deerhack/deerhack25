...
const page = () => {
  return (
    <div className={`${cabinetRegular.className} md:text-lg `}>
      <br /><br /><br />
    <h1 className={`headings ${cabinetExtraBold.className} text-[3.5rem] mb-24 pt-32`}>Judging Criteria</h1>
    <div className={`${satoshiRegular.className} flex flex-col text-white md:px-24 px-[7.463rem] text-justify text-wrap font-[400]`}>
    <h2 className={`text-[2.25rem] headings  ${cabinetExtraBold.className} mb-10`}>Innovation</h2>
        <p className="leading-[155%] mb-3 text-[1.5rem]">
        ...
        <p className="leading-[155%] mb-10 text-[1.5rem]">
        The project is primarily marked on its creativity and uniqueness, as these elements serve as the cornerstone of innovation. How the end-result properly justifies the technologies used in the project heavily decides the marking for innovation, demonstrating not only a mastery of tools but also a deep understanding of their application to solve real-world problems.
        </p>
    <br /><br /><br />
        ...
        <p className="mb-10 leading-[155%] text-[1.5rem]">
